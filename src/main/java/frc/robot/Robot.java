...
public class Robot extends TimedRobot {
	...
	public void teleopPeriodic() {
		/* Gamepad processing */
		double forward = -1 * _gamepad.getY(Hand.kLeft);
		double turn = _gamepad.getTriggerAxis(Hand.kRight) - _gamepad.getTriggerAxis(Hand.kLeft);
	...
	void getButtons(boolean[] _currentBtns, XboxController gamepad) {
